...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFB5aHlPXaTiGIrAP4/z0/9a1p0AUQN0zcYHe34idMuMvzkrze5oi134UndMJbA==
::YB416Ek+ZG8=
::
::
...
START %conemu_exe% /icon %conemu_ico% /title "Download Remit Linee"  /loadcfgfile %conemu_cfgfile% /cmd cmd /k "%conemu_init% && cd /D %remit_linee_folder% && %ruby% %app% --enviroment=production download"
