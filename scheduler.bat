...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFB5aHlPXaTiGIrAP4/z0/9a1p0AUQN0zcYHe34i9I+gW7lDocIRj02Jf+A==
::YB416Ek+ZG8=
::
::
...
START %conemu_exe% /icon %conemu_ico% /title "Scheduler Download Remit Linee"  /loadcfgfile %conemu_cfgfile% /cmd cmd /k "%conemu_init% && cd /D %transmission_folder% && %ruby% %app%"
